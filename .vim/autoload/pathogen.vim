...
<script src="http://assets1.github.com/javascripts/bundle_github.js?07900fb35f607ca51edb7ddae3c9ea6792a80c53" type="text/javascript"></script>
  ...
  <body class="logged_in ">
    ...
    <div class="userbox">
      <div class="avatarname">
        <a href="http://github.com/emanueldima"><img src="http://www.gravatar.com/avatar/c17539580b1a3bd2a925baff54d75a4c?s=140&d=http%3A%2F%2Fgithub.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="20" height="20"  /></a>
        <a href="http://github.com/emanueldima" class="name">emanueldima</a>
    ...
    <ul class="actions">
        ...
        <li>
          ...
          <a href="/tpope/vim-pathogen/toggle_watch" class="minibutton btn-watch " id="unwatch_button" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/tpope/vim-pathogen/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'd2faeb61685593af9b4bfb17629aca9411c6593c'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
            <li class="for-hasfork" style="display:none"><a href="#" class="minibutton btn-fork " id="your_fork_button"><span><span class="icon"></span>Your Fork</span></a></li>
          

          <li id='pull_request_item' class='nspr' style='display:none'><a href="/tpope/vim-pathogen/pull/new/master" class="minibutton btn-pull-request "><span><span class="icon"></span>Pull Request</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/tpope/vim-pathogen/watchers" title="Watchers" class="tooltipped downwards">110</a></li>
          <li class="forks"><a href="/tpope/vim-pathogen/network" title="Forks" class="tooltipped downwards">8</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul class="tabs">
    ...
    <li><a href="/tpope/vim-pathogen/network" highlight="repo_network">Network (8)</a></li>

    

    
      
      <li><a href="/tpope/vim-pathogen/issues" highlight="issues">Issues (2)</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/tpope/vim-pathogen/edit/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="d2faeb61685593af9b4bfb17629aca9411c6593c" /></div>
...
<span id="LID133" rel="#L133">133</span>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=0MsR2VXQ9vvY10LcdQTPaiXAePbnyDIqOthUkH5akxII3MmB4NXZCqROi_TNDGatdPVamgQrCs1bjJAkRTDG9GFmYw2Z7dhwuPdoKx13gNuFm3PrmhxMidaypCqNZfnO0TwLzfzM-2IcioeUJZZq0iss3c0qmLGS6Akvu-QJGdwkUDiQtor9qdq2XBt4KBIgb2w8H8qmpedlni9l7CQ14KTL07YbH88Fox163RZTKBIJeuKivwJl8ib5oo_aNwNq">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2010 <span id="_rrt" title="0.10792s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
        ...
        <div class="locales">
          <div class="site">
            ...
            <ul class="choices clearfix limited-locales">
              <li><span class="current">Indonesia</span></li>
            ...
            <div class="all-locales clearfix">
              <h3>Your current locale selection: <strong>Indonesia</strong>. Choose another?</h3>
    ...
    <script>window._auth_token = "d2faeb61685593af9b4bfb17629aca9411c6593c"</script>
