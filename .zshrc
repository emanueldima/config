...
export SOPS_PATH=/usr/local/bin/sops
...
alias start-ubuntu22="vftool -k ~/ubuntu-vm-22/kernel -i ~/ubuntu-vm-22/initrd -d ~/ubuntu-vm-22/disk.img -m 8192 -a \"root=/dev/vda console=hvc0\" -t 0"
